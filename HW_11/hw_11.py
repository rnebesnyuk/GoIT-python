...
book.add_record("vasia", ["123456789012", "+38(098)444-42-45", '111111111111'], '03.05.1985')
...
# #print(rec)
# rec2.edit_number('111111111111', '123456789012')
# print(rec2)
# rec2.remove_number('111111111111')
# print(rec2)
# rec.add_number("999944434567")
# #print(rec)
# rec.add_number('444444123456') 
# book.delete_record("senia")

print(next(book.iterator(2)))
print('************')
#OR
