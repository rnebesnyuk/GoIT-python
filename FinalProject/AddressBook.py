...
class AddressBook(UserList):
    ...
    def add(self, record):
        ...
        logger.log(level=logging.INFO, msg=f"Contact {record.name} has been added.")

    def save(self, file_name):
        with open(file_name + ".bin", "wb") as file:
            pickle.dump(self.data, file)
        logger.log(level=logging.INFO, msg=f"Addressbook has been saved!")
    ...
    def load(self, file_name):
        ...
        if emptyness.st_size != 0:
            ...
            logger.log(level=logging.INFO, msg=f"Addressbook has been loaded!")
        else:
            logger.log(level=logging.INFO, msg=f"Addressbook has been loaded!")
        return self.data
    ...
    def edit(self, contact_name, parameter, new_value):
        ...
        try:
            ...
            logger.log(
                level=logging.INFO, msg=f"Contact {contact_name} has been edited!"
            )
            return True
        return False
    ...
    def remove(self, pattern):
        ...
        for account in self.data:
            if account["name"] == pattern:
                ...
                logger.log(
                    level=logging.INFO,
                    msg=f"Contact {account['name']} has been removed!",
                )
                flag = True
